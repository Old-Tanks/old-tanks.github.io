package alternativa.tanks.gui
{
   ...
   public class GarageWindow extends Sprite
   {
      ...
      public function resize(width:int, height:int) : void
      {
         ...
         this.tankPreview.resize(width - this.itemInfoPanelWidth,height - this.myItemsWindow.height - this.shopItemsWindow.height);
      ...
      public function addItemToWarehouse(itemId:String, itemParams:ItemParams, itemInfo:ItemInfo) : void
      {
         ...
         this.warehouseList.addItem(itemId,itemParams.name,itemParams.itemType.value,itemParams.itemIndex,itemParams.price,itemParams.rankId,false,true,itemInfo.count,previewBd,itemParams.modificationIndex);
      }
      ...
      public function addItemToStore(itemId:String, itemParams:ItemParams) : void
      {
         ...
         var userRank:int = int(panelModel.rank);
         var previewBd:BitmapData = ResourceUtil.getResource(ResourceType.IMAGE,itemId + "_preview").bitmapData;
         this.storeList.addItem(itemId,itemParams.name,itemParams.itemType.value,itemParams.itemIndex,itemParams.price,userRank >= itemParams.rankId ? 0 : itemParams.rankId,false,false,0,previewBd,0);
      }
